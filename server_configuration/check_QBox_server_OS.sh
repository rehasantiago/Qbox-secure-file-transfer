...
linuxType=`cat /etc/os-release | awk 'NR==1{print $1}'`
linuxType=`echo $linuxType |sed 's/"//g'|cut -d\= -f2`
ubuntuVersion=`cat /etc/os-release | awk 'NR==5{print $2}'`
ubuntuVersion=`echo $ubuntuVersion |cut -d\. -f1`
